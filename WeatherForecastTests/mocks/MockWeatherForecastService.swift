...
func getWeatherDetails(lastFetchTime: Date = Date()) -> WeatherResponse {
    ...
    return WeatherResponse(current: current, forecast: forecast, lastFetchTime: lastFetchTime)
}

func getFourHoursEarlier() -> Date? {
